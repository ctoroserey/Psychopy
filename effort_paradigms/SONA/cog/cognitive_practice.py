...
"""To do:
    -  Think about rounding up/down the RTs
    -  Create a function for logs """
...
expName = 'cogTaskSona'  # from the Builder filename that created this script
...
blockLength = 90 # how long in seconds each timing block will be. This controls the total experiment time
    ...
    while blockClock.getTime() < blockLength:
        ...
        for i in mentalOrder:
            ...
            if i == 0:
                ...
                if taskResponse[0] is not 1: # testing this for now, instead of leaving it within the function
                    isi.draw()
                    win.flip()
                    core.wait(isiTime)
            elif i == 1:
